...
const customerRoutes = [
    ...
    { path: '/packages/:slug', component: () => import('../pages/customer/PackageDetailPage.vue'), name: 'package.detail' },
    { path: '/booking/:slug', component: () => import('../pages/customer/BookingPage.vue'), name: 'booking', meta: { requiresAuth: true } },
...
const adminRoutes = [
    {
        ...
        children: [
            ...
            { path: 'packages/:slug/edit', component: () => import('../pages/admin/PackageFormPage.vue'), name: 'admin.packages.edit' },
...
const merchantRoutes = [
    {
        ...
        children: [
            ...
            { path: 'packages/:slug/edit', component: () => import('../pages/merchant/PackageFormPage.vue'), name: 'merchant.packages.edit' },
